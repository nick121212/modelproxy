(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["modelproxy-engine-fetch"] = factory(require("modelproxy"));
	else
		root["modelproxy-engine-fetch"] = factory(root["modelproxy"]);
})(window, function(__WEBPACK_EXTERNAL_MODULE_modelproxy__) {
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/fetch.engine.ts");
/******/ })
/************************************************************************/
/******/ ({
...
Object.defineProperty(exports, "__esModule", { value: true });
var modelproxy_1 = __webpack_require__(/*! modelproxy */ "modelproxy");
var promiseFactory = new modelproxy_1.BaseFactory();
/**
 * 为fetch增加cache的功能
 * 返回新的promise
 ...
 * @returns {Promise<any>}
 */
exports.fetchCacheDec = function (fetchPromise, ctx, fullPath) {
    var _a = ctx.executeInfo,
        executeInfo = _a === void 0 ? {} : _a;
    var settings = executeInfo.settings,
        instance = executeInfo.instance;
    var _b = (settings || {}).cache,
        cache = _b === void 0 ? false : _b,
        _c = (instance || {}).method,
        method = _c === void 0 ? "" : _c,
    ...
    // 从缓存中提取文档，如果没有，则添加
    var promiseInCache = promiseFactory.get(proKey);
    if (promiseInCache) {
...
var fetch_cache_1 = __webpack_require__(/*! ./fetch.cache */ "./src/fetch.cache.ts");
var fetch_decorator_1 = __webpack_require__(/*! ./fetch.decorator */ "./src/fetch.decorator.ts");
var defaultHeaders = {
    "Accept": "application/json",
    "Content-Type": "application/json"
};
var FetchEngine = /** @class */function (_super) {
    tslib_1.__extends(FetchEngine, _super);
    ...
    FetchEngine.prototype.init = function () {
        ...
        this.use(function (ctx, next) {
            return tslib_1.__awaiter(_this, void 0, void 0, function () {
                var formData, bodyParams, _a, executeInfo, _b, instance, body, headers, _c, _d, timeout, _e, originHeaders, _f, type, _g, fetchOptions, fullPath, key, data, fetchFunc, _h;
                return tslib_1.__generator(this, function (_j) {
                    switch (_j.label) {
                        case 0:
                            formData = new URLSearchParams(), bodyParams = new URLSearchParams(), _a = ctx.executeInfo, executeInfo = _a === void 0 ? {} : _a, _b = ctx.instance, instance = _b === void 0 ? {} : _b, headers = { "X-Requested-With": "XMLHttpRequest" }, _c = executeInfo.settings || {}, _d = _c.timeout, timeout = _d === void 0 ? 5000 : _d, _e = _c.headers, originHeaders = _e === void 0 ? {} : _e, _f = _c.type, type = _f === void 0 ? "" : _f, _g = _c.fetch, fetchOptions = _g === void 0 ? {} : _g, fullPath = this.getFullPath(instance, executeInfo);
                            // 根据type来设置不同的header
                            switch (type) {
                                case "params":
                            ...
                            fetchFunc = fetch.bind(fetch, fullPath, Object.assign({}, {
                            ...
                            // 发送请求
                            _h = ctx;
                            return [4 /*yield*/, fetch_decorator_1.fetchDec(fetch_cache_1.fetchCacheDec(fetchFunc, ctx, fullPath), timeout)];
                        case 1:
                            // 发送请求
                            _h.result = _j.sent();
                            return [4 /*yield*/, next()];
    ...
    FetchEngine.prototype.proxy = function (instance, options) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/, this.callback()(Object.assign.apply(Object, [{
                            executeInfo: options,
                            instance: instance
                        }].concat(otherOptions)))];
                    case 1:
...
/***/ "modelproxy":
/*!**********************************************************************************************************!*\
  !*** external {"root":"modelproxy","amd":"modelproxy","commonjs2":"modelproxy","commonjs":"modelproxy"} ***!
  \**********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = __WEBPACK_EXTERNAL_MODULE_modelproxy__;
